...
-->
<!--
This one is embedding weirdly, it's hard to read
...
subgraph Courses at Home Schools
    subgraph Middle or High Schools
        A[Algebra  1] --> B[Computer Programming]
    end
    
    A --> C[AP CS Principles]
    B --> D[Computer Programming Advanced]
    B --> E[AP CS A]
    C -.-> E
end

subgraph Courses at ACC
    subgraph NOVA Associates Program
        A --> F[DE Computer Programming] 
        F --> G[DE Computer Programming Intensified]
        G --> H[DE Computer Programming Advanced]
    end
    subgraph Web Development Pathway
        I[Web Page Design & Multimedia] --> F
        F --> J[Database Design & Management]
    end
